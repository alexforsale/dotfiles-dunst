...
#+begin_src conf
  ...
  #   %%  Literal %
  # Markup is allowed
  format = "<span size='x-large' font_desc='Cantarell,JetBrainsMonoNL Nerd Font Mono 8' weight='bold'>%s</span>\n%b"
#+end_src
**** Alignments
#+begin_src conf
...
This is the base configuration file, and each configuration in it will be replaced with the snippets in =~/.config/dunst/dunstrc.d/*.conf=.
* Scripts
** dunst-backlight
:PROPERTIES:
